...
const tours = [
  {
    ...
    desc: "The Wrebels are back in business! Join Jarrad Wrigley and the Wrebels for one hell of a night as they showcase a brand new show, packed full of energy, heartfelt stories and raw talent.",
...
export default function DesktopTourDatesPage() {
  return (
    <>
        ...
        <div className="px-[7rem] ">
          <div className="bg-white/10 backdrop-blur-md border border-white/20  shadow-lg ">
            <div className="w-full p-6 border-[0.5px] border-white flex justify-between items-center">
              ...
              <button
                className="bg-black hover:text-black cursor-pointer hover:bg-white/40 hover:backdrop-blur-md text-white py-1 px-[1rem] border-[0.2px] border-gray-100 "
              >
                <span>Track Artist</span>
              </button>
            </div>

            <div className="flex flex-col overflow-y-auto max-h-[24rem] ">
